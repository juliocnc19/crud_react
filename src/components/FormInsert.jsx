...
export default function FormInsert({createProduct}) {
      ...
      >
        ...
        <div className="flex flex-col mb-5">
          ...
          <input
            ...
            className="transition-all duration-200 hover:bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg outline-none p-2"
            required
          />
        </div>
        ...
        <input
          type="submit"
          value="Agregar"
          className="transition-all duration-200 bg-green-100 hover:bg-green-200 border border-gray-300 text-gray-600 text-sm rounded-lg outline-none p-2 font-bold"
        />
      </form>
    </div>
  );
